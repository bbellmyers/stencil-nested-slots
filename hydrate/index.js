...
const hpFaqAccordionCss = "/*!@:host*/.sc-hp5-faq-accordion-h{display:block;box-sizing:border-box;padding:6px;border:1px solid red;margin:6px}";

class HpFaqAccordion {
  constructor(hostRef) {
    registerInstance(this, hostRef);
  }
  render() {
    return (hAsync(Host, null, hAsync("p", null, "hp5-faq-accordion"), hAsync("slot", null)));
  }
  static get style() { return hpFaqAccordionCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "hp5-faq-accordion",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
const hpFaqAccordionContainerCss = "/*!@:host*/.sc-hp5-faq-accordion-container-h{display:block;box-sizing:border-box;border:1px solid green}";

class HpFaqAccordionContainer {
  constructor(hostRef) {
    registerInstance(this, hostRef);
  }
  render() {
    return (hAsync(Host, null, "hp5-faq-accordion-container", hAsync("slot", null)));
  }
  static get style() { return hpFaqAccordionContainerCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "hp5-faq-accordion-container",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
const myComponentACss = "/*!@:host*/.sc-my-component-a-h{display:block;box-sizing:border-box;border:1px solid green}";
...
class MyComponentA {
  ...
  render() {
    return (hAsync(Host, null, "my-component-a", hAsync("slot", null)));
  }
...
const myComponentBCss = "/*!@:host*/.sc-my-component-b-h{display:block;box-sizing:border-box;padding:6px;border:1px solid red;margin:6px}";
...
class MyComponentB {
  ...
  render() {
    return (hAsync(Host, null, hAsync("p", null, "my-component-b"), hAsync("slot", null)));
  }

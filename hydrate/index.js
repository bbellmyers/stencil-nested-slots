...
/*!
 Stencil Mock Doc v3.2.1 | MIT Licensed | https://stenciljs.com
 */
...
const myComponentACss = "/*!@:host*/.sc-my-component-a-h{display:block;border:1px solid red;box-sizing:border-box;padding:6px}";
...
class MyComponentA {
  ...
  render() {
    return (hAsync(Host, null, "Component A", hAsync("slot", null)));
  }
  static get style() { return myComponentACss; }
...
const myComponentBCss = "/*!@:host*/.sc-my-component-b-h{display:block;border:1px solid green;box-sizing:border-box;padding:6px}";
...
class MyComponentB {
  ...
  render() {
    return (hAsync(Host, null, "Component B", hAsync("slot", null)));
  }
  static get style() { return myComponentBCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
